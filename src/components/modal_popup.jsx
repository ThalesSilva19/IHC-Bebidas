      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <ThemeProvider theme={theme}>
            <Typography variant='h2' sx={{ textAlign: 'center', fontSize: 'calc(30px + 1.2vw)' }}>Você tem mais de 18 anos?</Typography>
            <Typography variant='h4' sx={{ textAlign: 'center', fontSize: 'calc(22px + 1.2vw)' }}>O consumo de bebidas alcoólicas é proibido para menores de 18 anos</Typography>
          </ThemeProvider>
          <Box sx={{
            display: 'flex',
            flexDirection: 'row'
